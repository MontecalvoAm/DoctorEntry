...
const UserModal = ({ onSuccess, onCancel, currentUserEmail, mode = 'create', initialData })=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const isDuplicate = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkDuplicate"])('M_Users', 'Email', trimmedEmail, excludeId);
            if (isDuplicate) {
            ...
            if (password) {
                ...
                const salt = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].genSaltSync(10);
                const hashedPassword = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].hashSync(trimmedPassword, salt);
                userData.Password = hashedPassword;
            }
            let result;
            if (isEdit && initialData?.id) {
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateFormData"])('M_Users', initialData.id, userData, currentUserEmail);
                ...
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveFormData"])('M_Users', userData, currentUserEmail);
            }
            if (result.success) {
                onSuccess();
            } else {
...
const AdminDashboard = ()=>{
    ...
    const handleDelete = async ()=>{
        ...
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateFormData"])(collectionName, selectedItem.id, {
                IsActive: false
    ...
    const fetchData = async ()=>{
        ...
        try {
            const collectionName = activeTab === 'doctors' ? 'doctors' : 'M_Users';
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCollectionData"])(collectionName);
            if (result.success) {
                if (activeTab === 'doctors') {
...
_s(AdminDashboard, "l+0nKDdRXpaw0dR4hw+9IYjjfHc=");
_c = AdminDashboard;
...
//# sourceMappingURL=src_70620d06._.js.map