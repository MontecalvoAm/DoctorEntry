...
"[project]/src/app/api/admin/sync-claims/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        for (const doc of usersSnapshot.docs){
            ...
            try {
                ...
                const authUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminAuth"].getUser(uid);
                // Set custom claims
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setCustomUserClaims"])(uid, role);
                results.push({
                    email,
                    role,
                    status: 'success',
                ...
                console.error(`Error processing Auth for ${email}:`, authError.message);
                results.push({
                    email,
                    role,
                    status: 'failed',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c8f0f5ca._.js.map